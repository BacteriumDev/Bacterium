				...
				<div id="login">
					...
					<form class="boxCont" method="POST" onsubmit="return validateFormOnSubmit(this)">
						...
						<div>
							...
							<input id="bac_email" type="text" name="email" placeholder="Escriba aqui su correo electrónico" value="<?php echo $email ?>"/>
						</div>
						...
						<div>
							...
							<input id="bac_age" type="text" name="age" placeholder="Escriba aquí su edad" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" maxlength="2" value="<?php echo $edad ?>"/>
						</div>
						
						<div>
							<label for="about">Datos adicionales</label>
							<input id="bac_about" type="text" name="about" placeholder="Acerca de usted" value="<?php echo $acerca ?>"/>
						</div>
