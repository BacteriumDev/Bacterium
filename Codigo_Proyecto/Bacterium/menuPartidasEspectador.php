<?php
	...
	WHERE
		tipo_partida = 'multiplayer' AND estado = 'creada' AND numero_jugadores > 1"; //cambiar creada a activa
?>
...
<link href="stylesheets/table.css" rel="stylesheet" type="text/css">
	...
	<body>
		<div id="wrapper">
			...
			<h2>Partidas posibles de espectar</h2>
		<div id="content">
		...
		<tbody>
			<?php
				...
				while($row = mysql_fetch_array($result)){ 
					...
					echo "<td valign='top'><a href=partidaEspectador.php?id={$row['idPartidas']}>Entrar como espectador</a></td>"; 
					echo "</tr>"; 
				}
			?>
		</tbody>
