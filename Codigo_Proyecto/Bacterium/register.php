...
<script src="scripts/validatorreg.js"></script>
	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="logincontent">
				<div id="login">
					<h2>Complete la informacion de registro</h2>
					<form class="boxCont" method="POST" onsubmit="return validateFormOnSubmit(this)">
						...
						<div>
							...
							<input id="bac_email" type="text" name="email" placeholder="Escriba aqui su correo electrónico" />
						</div>
						...
						<div>
							...
							<input id="bac_age" type="text" name="age" placeholder="Escriba aquí su edad" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" maxlength="2"/>
						</div>
						
						<div>
							<label for="about">Datos adicionales</label>
							<input id="bac_about" type="text" name="about" placeholder="Escriba acerca de usted" />
						</div>
						
						<div>
							<input type="submit" id="signIn" name="signIn" value="Registrarse" class="btn right" />
						</div>
					</form>
				</div>
			</div>
